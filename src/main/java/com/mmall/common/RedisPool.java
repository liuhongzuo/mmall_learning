...
public class RedisPool {
    ...
    private static Boolean testOnReturn = Boolean.parseBoolean(PropertiesUtil.getProperty("redis.test.return","true"));//在return一个jedis实例的时候，是否要进行验证操作，如果赋值true。则返回jedispool的jedis实例肯定是可以用的。
    ...
    private static void initPool(){
        ...
        pool = new JedisPool(config,redisIp,redisPort,1000*2);//超时时间2s
    }
